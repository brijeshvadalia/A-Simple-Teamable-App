...
> # All About `Teamable App` 😎

# **Gained expertise through this project :**

- Learned the basic of `HTMl` , `CSS` , `JAVASCRIPT`.
...
>## Better to remain silent and be thought a fool than to show the hard-coded CSS in your JavaScript code and remove all doubt.
